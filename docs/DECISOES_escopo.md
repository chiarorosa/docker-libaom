...
| ~~2~~ | ~~**ConvNeXt** — retreino com alvo de *regret*; o teto de pixels foi medido com modelo sobreajustado e objetivo errado~~ | pode mudar uma conclusão | **REABERTO E FECHADO DE NOVO 20/08.** O fechamento de 26/07 ("refutado, piorou 1,06–3,80×") era artefato: o braço de CE fora treinado em outro corpus, com 2 das 6 seqs da vara contaminadas. Sob controle real, o alvo de *regret* é **melhor**. A premissa do "sobreajuste" continua **falsa** (§4 do doc). O achado maior sobrevive e cresce: o ConvNeXt perde para as 24 colunas compactas por **4,1×** e **não é teto de pixels**. `RESULTADOS_auditoria_convnext_corpus.md` |
