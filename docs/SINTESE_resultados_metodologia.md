...
| Escada informacional RPP (A / A+B / A+C / A+B+C) | ✅ **concluído** (2026-08-20) — receita fixa, 3 sementes, grade densa da variância; **o bloco B carrega o sinal (1,60×) e o bloco C nada acrescenta**; A+B domina A+B+C de 14,2% de cost_red em diante | `RESULTADOS_rpp_escada_informacional.md` |
