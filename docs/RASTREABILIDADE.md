...
| `train_student_h9.py` (flag `--class-weight`) | B4: treino com ponderação de classe por nível → `student_h9a_otimo`. **Resultado negativo** (não implantar); valida o treino sem peso | dataset | `student_h9a_otimo/students.pt` |
