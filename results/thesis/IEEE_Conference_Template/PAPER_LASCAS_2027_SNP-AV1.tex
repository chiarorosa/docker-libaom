...
\begin{figure}[!t]
  ...
  the libaom v3.10.0 anchor at \texttt{cpu-used=0}. Inside each calibration the
  three points differ only in the strength of the second pruner; the dashed line
  is the threshold knob of the first stage, and the inset resolves the balanced
  calibration, where the two prices leave the same operating point.}
  \label{fig_space}
\end{figure}
