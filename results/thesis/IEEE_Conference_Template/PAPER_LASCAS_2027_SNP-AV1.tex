...
\begin{figure}[!t]
  ...
  the threshold knob of the first stage, which leaves the base of the family in
  (a) and reaches it in (b). The two lines of (a) leave the same operating point,
  and the second stage buys time along it at about a third of the price of the
  knob.}
  \label{fig_space}
\end{figure}
