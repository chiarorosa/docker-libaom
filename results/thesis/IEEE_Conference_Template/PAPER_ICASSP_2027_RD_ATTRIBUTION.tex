...
this work exploits. Before the search of a node begins, the encoder
...
\eqref{eqn_cost}, and the work of the full search. It is a counted quantity and not wall-clock time, and it is not an
...
cost weighting was not swept. The comparison is nevertheless conservative, since
every one of these choices was resolved in favor of the deep arm.
