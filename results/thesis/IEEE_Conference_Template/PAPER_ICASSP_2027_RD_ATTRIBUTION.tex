...
partition node. Each band is shaded from the instant the encoder holds it, so the
three column blocks are free at the pre-search instant addressed in this work,
while the rate-distortion costs are not yet defined there.}
\label{fig_timeline}
\end{figure}
